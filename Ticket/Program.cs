using Event.MessageBroker;
using MassTransit;
using Microsoft.AspNetCore.Authentication.JwtBearer;
using Microsoft.EntityFrameworkCore;
using Microsoft.OpenApi.Models;
using Ticket.MessageBroker;
...
builder.Services.AddMassTransit(mt =>
{
    ...
    // Event
    mt.AddConsumer<CreateEventConsumer>();
    mt.AddConsumer<DeleteEventConsumer>();
    mt.AddConsumer<UpdateEventConsumer>();
    // Payment
    mt.AddConsumer<PaidTicketConsumer>();
    // Notification
